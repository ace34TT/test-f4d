    ...
    <div className={"w-full h-full absolute top-0 left-0 z-0"}>
      <div className={"relative w-full h-full"}>
        ...
        <AnimatedImage
          ...
          className={"-right-24 absolute top-1/2  transform -translate-y-1/2"}
        ...
        />
        <AnimatedImage
          src="images/hero_bg/5.png"
          className={
            "right-[400px] absolute top-1/2  transform -translate-y-[300px]"
          }
          animationConfig={{
            toB: {
              y: "+100",
        ...
        />
        <AnimatedImage
          src="images/hero_bg/6.png"
          className={
            "right-[150px] rotate-45 absolute top-1/2  transform -translate-y-1/2"
          }
          animationConfig={{
            toB: {
              y: "+100",
